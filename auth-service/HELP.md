...
* The original package name 'com.pabloph.auth-service' is invalid and this project uses 'com.pabloph.auth_service' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/4.0.8/how-to/data-initialization.html#howto.data-initialization.migration-tool.liquibase)
